package com.example.mine.client;
 ...
 */
public class Mine implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				errorLabel.setText("");
				String textToServer = aField.getText()+" "+bField.getText()+" "+cField.getText();
		...
		bField.addKeyUpHandler(handler);
		cField.addKeyUpHandler(handler);
	}
}
